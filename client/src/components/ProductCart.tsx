    ...
    <div className="shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button className="ring-1 ring-gray-200 shadow-lg px-2 py-1 rounded-md text-xs hover:text-white hover:bg-black transition-all cursor-pointer flex items-center gap-1 ml-2">
